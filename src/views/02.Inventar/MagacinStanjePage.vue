      ...
      <ion-content class="content">
        ...
        <div class="filter-icons-wrapper">
          <div class="filter-icons">
            <ion-button fill="clear" :color="isFilterActive('polistirol') ? 'danger' : 'medium'"
              @click="toggleFilter('polistirol')">
              <ion-icon :icon="flask"></ion-icon>
            </ion-button>
            <ion-button fill="clear" :color="isFilterActive('poliuretan') ? 'danger' : 'medium'"
              @click="toggleFilter('poliuretan')">
              <ion-icon :icon="flask"></ion-icon>
            </ion-button>
            ...
            <ion-button fill="clear" :color="isFilterActive('medijapan') ? 'danger' : 'medium'"
              @click="toggleFilter('medijapan')">
              <ion-icon :icon="leaf"></ion-icon>
            </ion-button>
            <ion-button fill="clear" :color="isFilterActive('iverica') ? 'danger' : 'medium'"
              @click="toggleFilter('iverica')">
              <ion-icon :icon="leaf"></ion-icon>
            </ion-button>
          </div>
        </div>
        ...
        <ion-list>
          <ion-item v-for="(row, index) in displayData" :key="index">
            ...
            <ion-label>
              Бљешка: {{ row.biljeska }}<br />
              Материјал: {{ row.materijal }}<br />
              Облик: {{ row.oblik }}<br />
              Ширина: {{ row.sirina }}<br />
              Дужина: {{ row.duzina }}<br />
              Дебљина: {{ row.debljina }}
              Количина: {{ calculateQuantity(row) }}
            </ion-label>
